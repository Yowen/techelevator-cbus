...
public class LectureTest {
	...
	@Test
	public void multiple_of_both_5_and_3_return_true() {
		// Arrange
		// Act
	...
	public void return_our_dog_returns_our_dog() {
		...
		// Assert
		// assertEquals uses the objects .equals(), o only works with an Override of .equals()
		// Assert.assertEquals(ourDog,  returnedDog);
		
		// If not .equals() Override on object, so only works with Override
		// Assert.assertEquals(ourDog, returnedDog);
