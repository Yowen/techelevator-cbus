...
public class Lecture {
	...
	public static void main(String[] args) {
		...
		*/
		...
		int batteryPercentageRemaining;
		batteryPercentageRemaining = 87;
		System.out.println(batteryPercentageRemaining);
		...
		*/
		...
		concatenatedString = "Hello, " + fullName;
		...
		*/
		...
		String fullString;
		fullString = concatenatedString + " Esquire";
