...
<body>
    ...
    <nav>
        ...
        <ul>
            <li><a href="<c:url value="/ageCalculator"/>">Alien Age</a></li>
            <li><a href="<c:url value="/weightCalculator"/>">Alien Weight</a></li>
            <li><a href="<c:url value="/driveTimeCalculator"/>">Drive Time</a></li>    
            <li><a href="<c:url value="/forum"/>">Space Forum</a></li>     
            <li><a href="<c:url value="/store/"/>">Space Store</a></li>                          
        </ul>
    </nav>