...
SELECT name, continent, population, gnp, lifeexpectancy FROM country
...
SELECT (gnp/population) AS per_capita_gnp FROM country
WHERE continent = 'Europe';

-- 22. The number of years since independence for all countries that have a year of independence (192 rows)
SELECT (2019 - indepyear) AS years_since_independence FROM country
